...
import { NUO_CONTACT_MAILTO, NUO_WHATSAPP_MX_URL, NUO_WHATSAPP_US_URL } from "@/lib/constants";
...
const ClosingCTASection = (): JSX.Element => {
  ...
  return (
    <section
      className="border-t border-border/70 bg-gradient-to-b from-card/40 to-background px-6 py-16 md:py-20"

    ...
    >
      <div className="container mx-auto min-w-0 px-4 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 id="sw-hw-heading" className="mt-3 font-heading text-2xl font-bold text-foreground md:text-4xl">
            {s.title}
          </h2>
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2">
          <motion.div
            className="card-glass-neon-cyan rounded-2xl p-6 md:p-8"
          ...
          >
            ...
            <h3 className="font-heading text-lg font-semibold text-foreground">{s.hardwareTitle}</h3>
          ...
          <motion.div
            className="card-glass-neon-cyan rounded-2xl bg-gradient-to-br from-cyan-500/[0.07] to-fuchsia-500/[0.05] p-6 md:p-8"
            initial={{ opacity: 0, y: 14 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-40px" }}
          ...
          >
            ...
            <h3 className="font-heading text-lg font-semibold text-foreground">{s.softwareTitle}</h3>
            <ul className="mt-4 space-y-2.5 text-sm text-muted-foreground">

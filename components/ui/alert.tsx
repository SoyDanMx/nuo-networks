...
const alertVariants = cva(
  "relative grid w-full items-start rounded-lg border px-4 py-3 text-sm has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] has-[>svg]:gap-x-3 [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current grid-cols-[0_1fr] gap-y-0.5",
  {
    variants: {
      variant: {
